...
// function enableFormValidation(unvalidatableFormElement) {
//  const validatableForm = new FormValidator(formSettings, unvalidatableFormElement);
//  return validatableForm.enableValidation();
// }
 ...
 * @param {Object} formSettings - configuration, contains generals classes and selectors names of form element
 */
function enableFormValidation(unvalidatableFormElement) {
  const validatableForm = new FormValidator(formSettings, unvalidatableFormElement);
...
// const validatableForms = (editProfileForm, addCardForm) => {
//   enableFormValidation(formSettings, addCardForm);
//   enableFormValidation(formSettings, editProfileForm);
// };
...
const validateForms = () => {
  ...
  getFormList.forEach((formElement) => {
    enableFormValidation(formElement);
  });
};
